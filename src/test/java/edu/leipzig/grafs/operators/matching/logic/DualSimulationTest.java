...
class DualSimulationTest {
  ...
  public void testBuildCandidates() {
    var graphLoader = AsciiGraphLoader.fromString(graphGdlStr);
    var graph = graphLoader.createGraph();
    var queryLoader = AsciiGraphLoader.fromString(queryGraphGdlStr);
