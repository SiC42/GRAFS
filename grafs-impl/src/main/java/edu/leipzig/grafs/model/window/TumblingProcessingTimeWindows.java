...
public class TumblingProcessingTimeWindows extends AbstractTumblingWindows {

  protected TumblingProcessingTimeWindows(Time size,
      Time offset, WindowStagger windowStagger) {
  ...
  public static TumblingProcessingTimeWindows of(Time size) {
    return new TumblingProcessingTimeWindows(size, null, null);
  }
  ...
  public static TumblingProcessingTimeWindows of(Time size, Time offset) {
    return new TumblingProcessingTimeWindows(size, offset, null);
  }
  ...
  public static TumblingProcessingTimeWindows of(
    ...
    return new TumblingProcessingTimeWindows(size, offset, windowStagger);
  }

  @Override
  public WindowAssigner<Object, TimeWindow> getFlinkWindowAssigner() {
    if(offset == null){
      return org.apache.flink.streaming.api.windowing.assigners.TumblingProcessingTimeWindows.of(size);
    } else if(windowStagger == null){
      return org.apache.flink.streaming.api.windowing.assigners.TumblingProcessingTimeWindows.of(size, offset);
    } else{
      return org.apache.flink.streaming.api.windowing.assigners.TumblingProcessingTimeWindows.of(size, offset, windowStagger);
    }
  }
