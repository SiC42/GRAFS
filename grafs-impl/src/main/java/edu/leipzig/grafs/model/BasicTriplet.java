 ...
 */
public class BasicTriplet<V extends Vertex, E extends Edge> implements Serializable {
   ...
   *                          IDs in the edge
   */
  public BasicTriplet(E edge, V sourceVertex, V targetVertex)
   ...
   * @param targetVertex target vertex of the given edge
   */
  public static BasicTriplet<Vertex, Edge> createTriplet(GraphElement prevEdge, GraphElement sourceVertex,
    ...
    return new BasicTriplet<>(e,source,target);
  }
   ...
   */
  public BasicTriplet<V,Edge> createReverseTriplet() {
    var reverseEdge = this.edge.createReverseEdge();
    return new BasicTriplet<>(reverseEdge, targetVertex, sourceVertex);
  }
  ...
  public boolean equals(Object o) {
    ...
    BasicTriplet<?,?> that = (BasicTriplet<?,?>) o;
