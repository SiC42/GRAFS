...
public class TumblingEventTimeWindows extends AbstractTumblingWindows {
  ...
  public WindowAssigner<Object, TimeWindow> getFlinkWindowAssigner() {
    if(offset == null){
      ...
      return org.apache.flink.streaming.api.windowing.assigners.TumblingEventTimeWindows.of(size, offset);
    } else{
      return org.apache.flink.streaming.api.windowing.assigners.TumblingEventTimeWindows.of(size, offset, windowStagger);
    }
  }
}
