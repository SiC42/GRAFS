...
public class Graph<V extends Vertex, E extends Edge> implements Serializable {
   ...
   * @param graphId  ID to be used for the graph
   */
  protected Graph(GradoopId graphId, Collection<V> newVColl, Collection<E> newEColl, Collection<V> vertices, Collection<E> edges) {
    this.id = graphId;
   ...
   */
  public static Graph<Vertex,Edge> fromTriplets(Iterable<Triplet> tripletIt) {
    var graph = new Graph<>();
