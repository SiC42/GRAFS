...
public class Graph<V extends Vertex, E extends Edge> implements Serializable {
   ...
   */
  public Graph(GradoopId graphId, Collection<V> vertices, Collection<E> edges) {
   ...
   * @param graphId  ID to be used for the graph
   */
  protected Graph(GradoopId graphId, Collection<V> newVColl, Collection<E> newEColl,
  ...
  /**
   * Constructs a graph from an triplet iterable and returns it. Returns the vertex-induced subgraph
   * for the given vertices, i.e. a graph with the given vertices (provided they are in this graph)
   * and all edges, for which both, the source and target vertex, are part of the subgraph.
   *
   * @param tripletIt iterable of triplets to be used for the construction of the graph
   * @return the constructed graph
   */
  public static <TV extends Vertex, TE extends Edge> Graph<TV, TE> fromTriplets(
      Iterable<Triplet<TV, TE>> tripletIt) {
    var graph = new Graph<TV, TE>();
   ...
   */
  public Graph<V, E> getVertexInducedSubGraph(Collection<V> vertices) {
    var vInducedSubGraph = new Graph<V, E>(vertices, new HashSet<>());
    for (var vertex : vertices) {
