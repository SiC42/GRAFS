...
package edu.leipzig.grafs.benchmark.utils;


/**
 * GeoUtils provides utility methods to deal with locations in New York City from gradoop-benchmarks.
 *
...
public class GeoUtils {
  ...
  private static final double DELTA_LON = 0.0056;
  private static final double DELTA_LAT = 0.005;

  // ( |LON_WEST| - |LON_EAST| ) / DELTA_LAT
  private static final int NUMBER_OF_GRID_X = 70;
  // ( LAT_NORTH - LAT_SOUTH ) / DELTA_LON
  private static final int NUMBER_OF_GRID_Y = 400;
